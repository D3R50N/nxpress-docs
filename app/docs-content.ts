...
export const DOCS_DATA: DocSection[] = [
  {
    ...
    number: "01",
    title: "Overview & CLI",
    summary: "@nxpress/core is an Express.js-based framework for Node.js providing file-based routing, template components, cascading middlewares, and automatic response handling.",
    subsections: [
      {
        id: "starting-server",
        title: "Starting the Server",
        description: "You can start your Nxpress application using the Nxpress CLI or via a custom entrypoint script.",
        codeSnippets: [
          {
    ...
    subsections: [
      {
        ...
        content: [
          ...
          "Intelligent auto-suggestions for all built-in template helpers (cn, icon, ternary, len, etc.).",
  ...
  },
  {
    ...
    subsections: [
      ...
      {
        id: "dynamic-slugs",
        title: "Dynamic Route Syntax & Slugs",
        table: {
  ...
  },
  {
    ...
    summary: "Every view template page can be paired with a TypeScript or JavaScript companion file to fetch data before rendering.",
    subsections: [
      {
        id: "props-export",
        title: "Props Export",
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ["tailwindCssUrl", "string", 'Path to compiled Tailwind stylesheet (default "/tailwind.css").'],
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ["contains(arr, val)", "Checks if array or string contains value."],
